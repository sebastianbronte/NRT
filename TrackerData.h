...
//Modifications: TrackData is converted in a virtual class to apply polymorphism
//In orther not to change much code and have almost the same code.

struct TrackerData
{
  TrackerData(NRMapPoint *pMapPoint)
  : Point(*pMapPoint)
  {};
  ...
  inline bool isOutlier() {return bOutlier;}
  inline void setOutlier(bool outlier) {bOutlier = outlier;}
